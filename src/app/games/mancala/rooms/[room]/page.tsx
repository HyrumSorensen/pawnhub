...
import { eventBus } from "../../MancalaEventSingleton";
import ChatBox from "@/components/ChatBox";
import { useIsMobile } from "@/hooks/useIsMobile";
import MancalaMobileRoom from "./MancalaMobileRoom"; // 👈 import your mobile file!
...
export default function MancalaRoomPage() {
  ...
  return (
    <main className="flex gap-12 p-4 justify-center">
      ...
      <div className="flex gap-4 items-center bg-[url('/assets/mancala/wood-bg.svg')] bg-cover bg-center h-full py-4 px-8 rounded-xl">
