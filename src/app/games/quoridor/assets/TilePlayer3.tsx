export default function TilePlayer3({
    width = 100,
    height = 100,
  }: {
    width?: number;
    ...
    return (
        ...
        <defs>
        <filter id="filter0_d_16_2" x="29" y="20" width="42.4562" height="68.0005" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
